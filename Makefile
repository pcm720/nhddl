...
EE_OBJS = main.o module_init.o common.o options.o gui.o gui_graphics.o gui_args.o pad.o launcher.o title_id.o target.o devices.o devices_mmce.o devices_bdm.o devices_iso.o devices_hdl.o
